...
System.setProperty("webdriver.chrome.driver","D://Software//SEL_JAR-20210901T092836Z-001//SEL_JAR//chromedriver_win32//chromedriver.exe");
		...
		driver.findElement(By.name("ctl00$MainContent$fmwOrder$txtName")).sendKeys("Binsa");
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox2")).sendKeys("Alanthara");

		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox3")).sendKeys("Trivandrum");
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox4")).sendKeys("Kerala");
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox5")).sendKeys("695607");
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_cardList_0")).click();
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox6")).sendKeys("789258147369");
		   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox1")).sendKeys("01/23");
		   ...
		   Select drop = new Select(driver.findElement(By.id("ctl00_MainContent_fmwOrder_ddlProduct")));  
		    ...
		    driver.findElement(By.id("ctl00_MainContent_fmwOrder_txtUnitPrice")).sendKeys("80");
			driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[1]/li[5]/input[2]")).click();
			   driver.findElement(By.id("ctl00_MainContent_fmwOrder_txtName")).sendKeys("Binsa");
			   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox2")).sendKeys("Alanthara");
			   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox3")).sendKeys("Trivandrum");
			   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox4")).sendKeys("Kerala");
			   driver.findElement(By.id("ctl00_MainContent_fmwOrder_TextBox5")).sendKeys("695607");
