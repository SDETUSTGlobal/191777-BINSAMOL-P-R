...
str1="Stranger in Moscow"
str_count1=str1.count('Moscow')
print("count of 'Moscow' is",str_count1)
str_count2=str1.count('Moscow',12,18)
print("The count of 'Moscow' using start/end",str_count2)